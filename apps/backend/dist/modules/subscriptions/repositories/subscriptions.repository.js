...
let SubscriptionsRepository = class SubscriptionsRepository {
    ...
    async findBySubscriber(subscriberId) {
        return this.repository.find({
            where: { subscriberId, deletedAt: (0, typeorm_2.IsNull)() },
            relations: ['channel', 'channel.user'],
        });
    }
    async findByChannel(channelId) {
        return this.repository.find({
            where: { channelId, deletedAt: (0, typeorm_2.IsNull)() },
            relations: ['subscriber'],
        });
    }
    async findOne(subscriberId, channelId) {
        return this.repository.findOne({
            where: { subscriberId, channelId, deletedAt: (0, typeorm_2.IsNull)() },
        });
    }
    async delete(subscriberId, channelId) {
